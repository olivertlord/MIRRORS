...
Jb=log(uib./kibc*1.0767*10*800.2^5/3.7403e-12);
    ...
    for n=1:k
        ...
        if (ui_average(m,n) < (cutoff1));
           ...
           error(m,n)=NaN;
            ...
            T(m,n)=(-1/wien(2)-12.57); %correction brings 4color and spec into line when using cal as unknown and 670-830 wavelength range
